...
/// <summary>
/// The outcome of a hot reload: the app's XAML was diffed against a previous version and the resulting
...
/// the reload could not run at all -- the XAML would not parse, or the provider could not be injected.
/// </summary>
public sealed record LiveXamlReloadResult
{
