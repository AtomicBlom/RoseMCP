...
/// is <c>net10.0-windows</c> and both test projects reference it without an output assembly. The
/// provider implements the same contract in <c>tap_channel.h</c>, and <see cref="ProtocolVersion"/> is
/// what says the two are the same one.
/// </para>
/// </summary>
