...
namespace Rose.ProbeApp.UwpModern
{
    ...
    sealed partial class App : Application
    {
        ...
        protected override void OnLaunched(LaunchActivatedEventArgs e)
        {
            ...
            try
            {
                throw new RoseUwpModernStartupException();
            }
            catch (RoseUwpModernStartupException)
            {
    ...
    internal sealed class RoseUwpModernStartupException : Exception
    {
        public RoseUwpModernStartupException()
            : base("rose uwp modern startup")
        {
        }
    }
}
