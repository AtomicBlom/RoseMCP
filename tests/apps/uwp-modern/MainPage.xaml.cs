...
namespace Rose.ProbeApp.UwpModern
{
    /// <summary>
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void Tick()
        {
            ...
            try
            {
                throw new RoseUwpModernProbeException(this.ticks);
            }
            catch (RoseUwpModernProbeException)
            {
        ...
        private void RemoveTransient()
        {
            ...
            try
            {
                throw new RoseUwpModernTransientRemovedException(this.ticks);
            }
            catch (RoseUwpModernTransientRemovedException)
            {
                // Swallowed on purpose; an attached debugger sees it first-chance.
            }
        }
    ...
    internal sealed class RoseUwpModernProbeException : Exception
    {
        public RoseUwpModernProbeException(int tick)
            : base("rose uwp modern probe tick " + tick)
        {
            this.Tick = tick;
        }
    ...
    /// </summary>
    internal sealed class RoseUwpModernTransientRemovedException : Exception
    {
        public RoseUwpModernTransientRemovedException(int tick)
            : base("rose uwp modern transient removed at tick " + tick)
        {
            this.Tick = tick;
        }
